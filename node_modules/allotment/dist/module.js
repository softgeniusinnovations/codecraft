...
var w = (b || (b = 1, function (e, t) {
    ...
    var x = "object" == typeof h && h && h.Object === Object && h,
...
var x = "allotment-module_splitView__L-yRc",
  ...
  N = "allotment-module_vertical__WSwwa",
  L = "allotment-module_horizontal__7doS8",
...
var J = c(function () {
    ...
    var e = /^\s+|\s+$/g,
      ...
      n = /^0o[0-7]+$/i,
      r = parseInt,
      s = "object" == typeof h && h && h.Object === Object && h,
...
class ve extends W {
  ...
  addView(e, t, i, n, r) {
    ...
    var o = this.orientation === se.Vertical ? new pe(e, t, s) : new de(e, t, s);
    if (this.viewItems.splice(n, 0, o), this.viewItems.length > 1) {
      var _e6 = this.orientation === se.Vertical ? new he(this.sashContainer, {
  ...
  moveView(e, t, i) {
    var n = this.getViewCachedVisibleSize(t),
      r = void 0 === n ? this.getViewSize(t) : ce.Invisible(n),
      s = this.removeView(t);
  ...
  layout(e) {
    ...
    if (this.size = e, this.proportions) for (var _t4 = 0; _t4 < this.viewItems.length; _t4++) {
      ...
      var _i4 = X(0, this.viewItems.length),
        _n2 = _i4.filter(e => this.viewItems[e].priority === fe.Low),
        _r2 = _i4.filter(e => this.viewItems[e].priority === fe.High);
  ...
  distributeViewSizes() {
    ...
    for (var _t6 of e) _t6.size = g(i, _t6.minimumSize, _t6.maximumSize);
  ...
  resize(e, t, i, n, r, s, o, a, u) {
    ...
    var h = X(e, -1, -1),
      c = X(e + 1, this.viewItems.length);
    if (r) for (var _e9 of r) G(h, _e9), G(c, _e9);
    if (n) for (var _e0 of n) U(h, _e0), U(c, _e0);
    ...
    for (var _e11 = 0, _i0 = t = g(t, z, w); _e11 < l.length; _e11++) {
      var _t9 = l[_e11],
        _n4 = g(f[_e11] + _i0, _t9.minimumSize, _t9.maximumSize);
      _i0 -= _n4 - f[_e11], _t9.size = _n4;
    }
    for (var _e12 = 0, _i1 = t; _e12 < m.length; _e12++) {
      var _t0 = m[_e12],
        _n5 = g(d[_e12] - _i1, _t0.minimumSize, _t0.maximumSize);
  ...
  distributeEmptySpace(e) {
    ...
    var n = X(0, this.viewItems.length),
      r = [],
      s = n.filter(e => this.viewItems[e].priority === fe.Low),
      o = n.filter(e => this.viewItems[e].priority === fe.Normal),
      a = n.filter(e => this.viewItems[e].priority === fe.High);
    r.push(...a, ...o, ...s), "number" == typeof e && U(r, e);
    for (var _e13 = 0; 0 !== i && _e13 < r.length; _e13++) {
      var _t1 = this.viewItems[r[_e13]],
        _n6 = g(_t1.size + i, _t1.minimumSize, _t1.maximumSize);
  ...
  updateSashEnablement() {
    ...
    for (var _e14 = 0; _e14 < this.sashItems.length; _e14++) {
      ...
      if (_a && _u) {
        ...
        _h && r[_e14] && (o > 0 || this.startSnappingEnabled) ? _n7.state = oe.Minimum : _c && t[_e14] && (o < this.contentSize || this.endSnappingEnabled) ? _n7.state = oe.Maximum : _n7.state = oe.Disabled;
      } else _n7.state = _a && !_u ? oe.Minimum : !_a && _u ? oe.Maximum : oe.Enabled;
    }
  }
  ...
  constructor(e, t) {
    ...
    if (this.minimumSize = 0, this.maximumSize = Number.POSITIVE_INFINITY, this.element = void 0, this.priority = void 0, this.snap = void 0, this.layoutService = void 0, this.layoutStrategy = void 0, this.layoutService = e, this.element = t.element, this.minimumSize = "number" == typeof t.minimumSize ? t.minimumSize : 30, this.maximumSize = "number" == typeof t.maximumSize ? t.maximumSize : Number.POSITIVE_INFINITY, "number" == typeof t.preferredSize) this.layoutStrategy = new ye(t.preferredSize);else if ("string" == typeof t.preferredSize) {
      ...
      if (k(_e20, "%")) {
        ...
        this.layoutStrategy = new be(_t14, this.layoutService);
      } else if (k(_e20, "px")) {
        var _t15 = Number(_e20.slice(0, -2));
        this.layoutStrategy = new ye(_t15);
      } else if ("number" == typeof Number.parseFloat(_e20)) {
        var _t16 = Number.parseFloat(_e20);
        this.layoutStrategy = new ye(_t16);
      } else this.layoutStrategy = new ge();
    } else this.layoutStrategy = new ge();
  ...
  return u(j, () => ({
    reset: () => {
      if (z) z();else {
        ...
        for (var _e21 = 0; _e21 < $.current.length; _e21++) W(_e21);
      }
    },
    resize: e => {
      var _T$current3;
    ...
    var t = _extends({
      ...
      descriptor: {
        ...
        views: p.map((e, t) => {
          ...
          var i = P.current.get(M.current[t]),
            n = new ze(H.current, _extends({
    ...
    T.current = new ve(D.current, t, g, _, E), T.current.on("sashDragStart", () => {
      ...
      if (w && T.current) {
        var _e22 = R.map(e => e.key);
        for (var _t17 = 0; _t17 < _e22.length; _t17++) {
          var _i11 = P.current.get(_e22[_t17]);
          void 0 !== (_i11 == null ? void 0 : _i11.visible) && _i11.visible !== T.current.isViewVisible(_t17) && w(_t17, T.current.isViewVisible(_t17));
        }
      }
    ...
    if (Y) {
      ...
      for (var _e24 = _r3.length - 1; _e24 >= 0; _e24--) {
        var _T$current5;
        _r3[_e24] && ((_T$current5 = T.current) != null && _T$current5.removeView(_e24), _t18.splice(_e24, 1), $.current.splice(_e24, 1));
      }
      var _loop = function _loop(_n9) {
        var _i$minSize2, _i$maxSize2, _i$priority2, _i$snap2, _T$current7;
        var i = P.current.get(_n9),
          r = new ze(H.current, _extends({
            element: document.createElement("div"),
            ...
            priority: (_i$priority2 = i == null ? void 0 : i.priority) != null ? _i$priority2 : fe.Normal
          }, (i == null ? void 0 : i.preferredSize) && {
            preferredSize: i == null ? void 0 : i.preferredSize
          }, {
            snap: (_i$snap2 = i == null ? void 0 : i.snap) != null ? _i$snap2 : v
          }));
        (_T$current7 = T.current) != null && _T$current7.addView(k.current.get(_n9), r, ce.Distribute, _e23.findIndex(e => e === _n9)), _t18.splice(_e23.findIndex(e => e === _n9), 0, _n9), $.current.splice(_e23.findIndex(e => e === _n9), 0, r);
      };
      for (var _n9 of _i12) {
        _loop(_n9);
      }
      for (; !S(_e23, _t18);) {
        var _loop2 = function _loop2(_n0) {
          ...
          if (e !== _i13) {
            var _T$current6;
            (_T$current6 = T.current) == null || _T$current6.moveView(k.current.get(_n0), e, _i13);
            var _r4 = _t18[e];
      ...
      var _loop3 = function _loop3(_t19) {
        ...
        void 0 !== n && ((_T$current8 = T.current) == null ? void 0 : _T$current8.resizeView(i, n));
      };
      ...
      var _loop4 = function _loop4(_t20) {
        ...
        var i = P.current.get(_t20),
          n = _e23.findIndex(e => e === _t20);
        i && we(i) && void 0 !== i.visible && ((_T$current9 = T.current) == null ? void 0 : _T$current9.isViewVisible(n)) !== i.visible && ((_T$current0 = T.current) == null ? void 0 : _T$current0.setViewVisible(n, i.visible));
      };
      for (var _t20 of [..._i12, ..._n8]) {
        _loop4(_t20);
      }
      var _loop5 = function _loop5(_t21) {
        var i = P.current.get(_t21),
        ...
        if (i && we(i)) {
          ...
          var _e25 = !1;
          void 0 !== i.minSize && $.current[n].minimumSize !== i.minSize && ($.current[n].minimumSize = i.minSize, _e25 = !0), void 0 !== i.maxSize && $.current[n].maximumSize !== i.maxSize && ($.current[n].maximumSize = i.maxSize, _e25 = !0), _e25 && ((_T$current1 = T.current) == null ? void 0 : _T$current1.layout());
        }
      };
      for (var _t21 of _n8) {
        _loop5(_t21);
